...
<div class="container" id="main">
    ...
    <legend><b>Book information </b></legend>
		<form:form method="POST" action="/library/editBook/${book.bookId}" modelAttibute="book">
			<p>
			...
			<input type="text" name="dateReleased" value = "${book.dateReleased}"/>
			<br><font size="2" face="Courier" color="gray">Input format : <b>(YYYY-MM-DD)</b></font> 
			<br>
			<p>
			<label for ="publishedBy">Published by</label>
			<input type="text" name="publishedBy" value="<c:out value="${book.publishedBy}"/>"/>
			<br>
			<p>
